...
export default function Navbar() {
  return (
    <nav className="text-white md:sticky absolute top-0 bg-none m-0 w-max md:text-2xl text-4xl flex-col md:text-center">
      ...
      <span className="w-screen border-b-primary-white backdrop-blur-xl border-b-2 p-4 hidden md:flex md:items-start md:gap-x-12 md:flex-row flex-wrap items-center justify-center gap-4 align-middle">
      ...
      <Link href="/app" className="w-full md:w-max">Webapp</Link>
